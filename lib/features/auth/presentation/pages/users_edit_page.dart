...
class EditarUserPage extends ConsumerStatefulWidget {
  final Usuario usuario;
  const EditarUserPage({required this.usuario, super.key});

  @override
  ConsumerState<EditarUserPage> createState() => _EditarUserPageState();
}

class _EditarUserPageState extends ConsumerState<EditarUserPage> {
  ...
  void initState() {
    ...
    _dniCtrl.text = widget.usuario.dni;
    _nombreCtrl.text = widget.usuario.nombre;
    _apellidosCtrl.text = widget.usuario.apellidos;
    ...
    _informacionCtrl.text = '';
    _datosMedicosCtrl.text = '';
    _medicacionCtrl.text = '';
  }
